/*
This code is forked from the original qgrid library https://github.com/quantopian/qgrid
Apache License 2.0, Copyright 2018 Quantopian, Inc.

For diffs, please compare to the original version found above.
*/
...
.q-grid .slick-header-column:hover {
    background-color: #efefef;
  }

.q-grid .slick-header-column:hover > .slick-resizable-handle {
...
.q-grid .slick-resizable-handle {
  ...
  border-left: 6px solid rgb(245, 245, 245);
...
.q-grid .slick-cell {
  ...
  /* needed for showing ellipsis when breaking row */
  /* https://stackoverflow.com/questions/17779293/css-text-overflow-ellipsis-not-working */
  text-overflow: ellipsis;
  overflow: hidden;
  white-space: nowrap;

  /* white-space: pre-wrap;  show leading and trailing white-space in strings */
  /* cannot be used when we want to show ellipses */
  /* other solution is to show whitespace via preprocessing them eg via adding the · character before sending to qgrid */
  /* for example via https://stackoverflow.com/questions/49996636/replace-leading-whitespace-with-other-other-char-python */

  /* we can use the &nbsp; when displaying HTLM in slickgrid cells - https://stackoverflow.com/questions/9840548/how-to-put-html-into-slickgrid-cell */
}
...
/* Dtype button - inspired by filter-button */

.q-grid .slick-header-column.active .dtype-button, .dtype-button:hover {
    background-color: #deeaf7;
  }

  .q-grid .slick-header-column.dtype-button-disabled .dtype-button {
    color: #bababa;
  }
