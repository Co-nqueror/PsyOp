...
(function (Private) {
    ...
    function CloseButton(props) {
        var _a;
        return (React.createElement("button", { className: `bp3-button bp3-minimal jp-Button jp-mod-minimal ${TOAST_CLOSE_BUTTON_CLASS}${props.closeIconMargin ? ` ${TOAST_CLOSE_BUTTON_MARGIN_CLASS}` : ''}`, title: (_a = props.title) !== null && _a !== void 0 ? _a : '', onClick: props.close },
            React.createElement(props.closeIcon, { tag: "span" })));
    }
    ...
    async function toast() {
        if (toastify === null) {
            ...
            ReactDOM.render(React.createElement(toastify.ToastContainer, { draggable: false, closeOnClick: false, hideProgressBar: true, newestOnTop: true, pauseOnFocusLoss: true, pauseOnHover: true, position: "bottom-right", className: "jp-toastContainer", transition: toastify.Slide, closeButton: ToastifyCloseButton }), container);
        }
